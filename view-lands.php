...
<html class="no-js">
    <head>
        ...
        <title>View Lands Listing || Sri Lanka Properties</title>
                            ...
                            <div class="row">
                                    ...
                                    <div class="single-property">
                                        ...
                                        <div class="property-slider">
                                            <div id="property-images" class="flexslider">
                                                <ul class="slides">
                                                    <li class="item"> <img src="images/realstate/lands/l1.jpg" alt=""> </li>
                                                    <li class="item"> <img src="images/realstate/lands/l2.jpg" alt=""> </li>
                                                    <li class="item"> <img src="images/realstate/lands/l3.jpg" alt=""> </li>
                                                    <li class="item"> <img src="images/realstate/lands/l1.jpg" alt=""> </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="property-grid">
                                        <ul class="grid-holder col-3">
                                            <li class="grid-item type-rent">
                                                <div class="property-block"> <a href="#" class="property-featured-image"> <img src="images/realstate/lands/l1.jpg" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Rent</span> </a>
                                            ...
                                            <li class="grid-item type-buy">
                                                <div class="property-block"> <a href="#" class="property-featured-image"> <img src="images/realstate/lands/l2.jpg" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Buy</span> </a>
                                                    <div class="property-info">
                                                        <h4><a href="#">232 East 63rd Street</a></h4>
                                                        <span class="location">Homagama</span>
                                            ...
                                            <li class="grid-item type-rent">
                                                <div class="property-block"> <a href="#" class="property-featured-image"> <img src="images/realstate/lands/l3.jpg" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Buy</span> </a>
                                                    <div class="property-info">
                                ...
                                <div class="sidebar right-sidebar col-md-4">
                                    <div class="widget">
                                        ...
                                        <div class="agent">
                                            <img src="images/realstate/agents/a1.png" alt="Naduni Gunawardene" class="margin-20">
                                            <h4><a href="agents.php">Naduni Gunawardene</a></h4>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vehicula dapibus mauris, quis ullamcorper enim aliquet sed. Maecenas quis eget tellus dui. Vivamus condimentum egestas.</p>
