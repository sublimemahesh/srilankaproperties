...
<html class="no-js">
    <head>
        ...
        <title>View Rentals Listing || Sri Lanka Properties</title>
                            ...
                            <div class="row">
                                    ...
                                    <div class="single-property">
                                        ...
                                        <div class="property-slider">
                                            <div id="property-images" class="flexslider">
                                                <ul class="slides">
                                                    <li class="item"> <img src="images/realstate/rentals/r1.jpg" alt=""> </li>
                                                    <li class="item"> <img src="images/realstate/rentals/r2.jpg" alt=""> </li>
                                                    <li class="item"> <img src="images/realstate/rentals/r3.jpg" alt=""> </li>
                                                    <li class="item"> <img src="images/realstate/rentals/r1.jpg" alt=""> </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="property-grid">
                                        <ul class="grid-holder col-3">
                                            <li class="grid-item type-rent">
                                                <div class="property-block"> <a href="#" class="property-featured-image"> <img src="images/realstate/rentals/r1.jpg" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Rent</span> </a>
                                                    <div class="property-info">
                                                        <h4><a href="#">116 Waverly Place</a></h4>
                                                        <span class="location">Ambalangoda</span>
                                                        <div class="price"><strong>$</strong><span>2800 Monthly</span></div>
                                                    </div>
                                            ...
                                            <li class="grid-item type-buy">
                                                <div class="property-block"> <a href="#" class="property-featured-image"> <img src="images/realstate/rentals/r2.jpg" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Buy</span> </a>
                                                    <div class="property-info">
                                                        <h4><a href="#">232 East 63rd Street</a></h4>
                                                        <span class="location">Maharaga</span>
                                            ...
                                            <li class="grid-item type-rent">
                                                <div class="property-block"> <a href="#" class="property-featured-image"> <img src="images/realstate/rentals/r3.jpg"alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Buy</span> </a>
                                                    <div class="property-info">
                                ...
                                <div class="sidebar right-sidebar col-md-4">
                                    <div class="widget">
                                        ...
                                        <div class="agent">
                                            <img src="images/realstate/a2 (2).png" alt="Nikoki Weerakoon" class="margin-20">
                                            <h4><a href="agents.php">Nikoki Weerakoon</a></h4>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vehicula dapibus mauris, quis ullamcorper enim aliquet sed. Maecenas quis eget tellus dui. Vivamus condimentum egestas.</p>
