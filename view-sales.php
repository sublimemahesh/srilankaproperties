                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="single-property">
                                        <h2 class="page-title view-city">116 Waverly Place, <span class="location">Colombo</span></h2>
                                        <div class="price"><strong>$</strong><span>2800 Monthly</span></div>
                                        <div class="property-amenities clearfix"> 
                                            <span class="area"><strong>For</strong>Rent</span> 
                                        ...
                                        <div class="property-slider">
                                            <div id="property-images" class="flexslider">
                                                <ul class="slides">
                                                    <li class="item"> <img src="images/realstate/sales/s1.jpg" alt=""> </li>
                                                    <li class="item"> <img src="images/realstate/sales/s2.jpg" alt=""> </li>
                                                    <li class="item"> <img src="images/realstate/sales/s3.jpg" alt=""> </li>
                                                    <li class="item"> <img src="images/realstate/sales/s4.jpg" alt=""> </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="property-grid">
                                        <ul class="grid-holder col-3">
                                            <li class="grid-item type-rent">
                                                <div class="property-block"> <a href="#" class="property-featured-image"> <img src="images/realstate/sales/s1.jpg" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Rent</span> </a>
                                                    <div class="property-info">
                                                        <h4><a href="#">116 Waverly Place</a></h4>
                                                        <span class="location">Pannipitiya</span>
                                                        <div class="price"><strong>$</strong><span>2800 Monthly</span></div>
                                                    </div>
                                            ...
                                            <li class="grid-item type-buy">
                                                <div class="property-block"> <a href="#" class="property-featured-image"> <img src="images/realstate/sales/s2.jpg" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Buy</span> </a>
                                                    <div class="property-info">
                                                        <h4><a href="#">232 East 63rd Street</a></h4>
                                                        <span class="location">Wijerama</span>
                                            ...
                                            <li class="grid-item type-rent">
                                                <div class="property-block"> <a href="#" class="property-featured-image"> <img src="images/realstate/sales/s3.jpg" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Buy</span> </a>
                                                    <div class="property-info">
                                ...
                                <div class="sidebar right-sidebar col-md-4">
                                    <div class="widget">
                                        <h3 class="widgettitle agent-title view-d-a">Agent</h3>
                                        <div class="agent">
                                            <img src="images/a2.png" alt="Natasha Perera" class="margin-20">
                                            <h4><a href="agents.php">Natasha Perera</a></h4>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vehicula dapibus mauris, quis ullamcorper enim aliquet sed. Maecenas quis eget tellus dui. Vivamus condimentum egestas.</p>
                                            <div class="agent-contacts clearfix">
                                                <a href="agents.php" class="btn btn-primary pull-right btn-sm">Contact Agent</a>
                                                <ul>
                                    ...
                                    <div class="widget">
                                        <h3 class="widgettitle">Featured Projects</h3>
                                        <div id="amenities">
                                            <div class="additional-amenities">
                                            <ul class="owl-carousel" id="clients-slider" data-columns="1" data-autoplay="yes" data-pagination="no" data-arrows="no" data-single-item="no" data-items-desktop="1" data-items-desktop-small="1" data-items-mobile="1" data-items-tablet="1">
                                                <li class="item"> <a href="#"><img src="images/realstate/p1.jpg" alt="" class="img-thumbnail"></a> </li>
                                                <li class="item"> <a href="#"><img src="images/realstate/p2.jpg" alt="" class="img-thumbnail"></a> </li>
                                                <li class="item"> <a href="#"><img src="images/realstate/p3.jpg" alt="" class="img-thumbnail"></a> </li>
                                                <li class="item"> <a href="#"><img src="images/realstate/p4.jpg" alt="" class="img-thumbnail"></a> </li>
