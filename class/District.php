...
class District {
    ...
    public function __construct($id) {
        if ($id) {
            ...
            $query = "SELECT `id`,`name`,`image_name`,`sort` FROM `district` WHERE `id`=" . $id;
    ...
    public function create() {
        ...
        $query = "INSERT INTO `district` (`name`,`image_name`,`sort`) VALUES  ('" . $this->name . "','" . $this->image_name . "' ,'" . $this->sort . "')";
