...
class TourPackage {
    ...
    public function __construct($id) {
        if ($id) {
            ...
            $query = "SELECT `id`,`tour_type`,`title`,`image_name`,`price`,`short_description`,`description`,`queue` FROM `tour_package` WHERE `id`=" . $id;
    ...
    public function create() {
        ...
        $query = "INSERT INTO `tour_package` (`tour_type`,`title`,`image_name`,`price`,`short_description`,`description`,`queue`) VALUES  ('"
                . $this->tourtype . "', '"
                . $this->title . "', '"
                . $this->image_name . "', '"
                . $this->price . "', '"
    ...
    public function NonSelectedTourType() {

        $query = "SELECT * FROM `tour_package` WHERE `tour_type` != 6";
