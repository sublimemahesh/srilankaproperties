...
class Offer {
    ...
    public function __construct($id) {
        if ($id) {
            ...
            $query = "SELECT `id`,`title`,`image_name`,`short_description`,`description`,`queue` FROM `offer` WHERE `id`=" . $id;
    ...
    public function create() {
        ...
        $query = "INSERT INTO `offer` (`title`,`image_name`,`short_description`,`description`,`queue`) VALUES  ('"
                . $this->title . "','"
                . $this->image_name . "', '"
    ...
    public function deletePhotos() {
        ...
        $allPhotos = $OFFER_PHOTO->getOfferPhotosById($this->id);

        foreach ($allPhotos as $photo) {

            $IMG = $OFFER_PHOTO->image_name = $photo["image_name"];
            unlink(Helper::getSitePath() . "upload/offer/gallery/" . $IMG);
            unlink(Helper::getSitePath() . "upload/offer/gallery/thumb/" . $IMG);

            $OFFER_PHOTO->id = $photo["id"];
            $OFFER_PHOTO->delete();
        }
    }
