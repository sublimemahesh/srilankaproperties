...
<html class="no-js">
    <head>
        ...
        <title>Rentals || Sri Lanka Properties</title>
                                ...
                                <div class="property-grid">
                                    <ul class="grid-holder col-3">
                                        <li class="grid-item type-rent">
                                            <div class="property-block"> <a href="view-rentals.php" class="property-featured-image"> <img src="images/realstate/rentals/r1.jpg" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Rent</span> </a>
                                        ...
                                        <li class="grid-item type-buy">
                                            <div class="property-block"> <a href="view-rentals.php" class="property-featured-image"> <img src="images/realstate/rentals/r2.jpg" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Buy</span> </a>
                                                <div class="property-info">
                                        ...
                                        <li class="grid-item type-rent">
                                            <div class="property-block"> <a href="view-rentals.php" class="property-featured-image"> <img src="images/realstate/rentals/r3.jpg" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Buy</span> </a>
                                                <div class="property-info">
                                        ...
                                        <li class="grid-item type-rent">
                                            <div class="property-block"> <a href="view-rentals.php" class="property-featured-image"> <img src="images/realstate/rentals/r3.jpg" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Rent</span> </a>
                                                <div class="property-info">
