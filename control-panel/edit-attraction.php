                            ...
                            <div class="body">
                                <form class="form-horizontal" method="post" action="post-and-get/attraction.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="map" class="form-control" value="<?php echo $ATTRACTION->map; ?>" autocomplete="off" name="map" required="true">
                                    ...
                                    <div class="col-md-12">                                       
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="file" id="planimage" value="<?php echo $ATTRACTION->plan_image; ?>" class="form-control" name="planimage">
                                                <img src="../upload/attraction/plan/<?php echo $ATTRACTION->plan_image; ?>" id="planimage" class="view-edit-img img img-responsive img-thumbnail" name="planimage" alt="old image">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="area" class="form-control" value="<?php echo $ATTRACTION->area; ?>"  name="area">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="price" class="form-control" value="<?php echo $ATTRACTION->price; ?>"  name="price">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-line">
                                            <textarea id="features" name="features" class="form-control" rows="5"><?php echo $ATTRACTION->features; ?></textarea> 
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="hidden" id="oldPlanImageName" value="<?php echo $ATTRACTION->plan_image; ?>" name="oldPlanImageName"/>
