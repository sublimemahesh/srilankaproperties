            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Property photos</h2>
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="view-property-photos.php?id=<?php echo $id ;?>">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/property-photo.php" class="form-horizontal" >
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    <?php
                                                    if (count($OPROPERTY_PHOTO) > 0) {
                                                        foreach ($PROPERTY_PHOTO as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/property/gallery/thumb/<?php echo $img["image_name"]; ?>" alt=""/>
