                            ...
                            <div class="body">
                                <form class="form-horizontal"  method="post" action="post-and-get/room.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="col-md-12 hidden">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="no_of_rooms" class="form-control" value="0" autocomplete="off" name="no_of_rooms" required="true">
                                    ...
                                    <div class="col-md-12 hidden">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="price" class="form-control" autocomplete="off" name="price" value="0" required="true">
