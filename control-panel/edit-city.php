                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                ...
                                <div class="body row">
                                    <form class="form-horizontal col-sm-9 col-md-12" method="post"
                                          action="post-and-get/city.php" enctype="multipart/form-data">
                                        <div class="row clearfix">
                                                ...
                                                <div class="form-group place-select">
                                                    <div class="form-line">
                                                        ...
                                                        <select class="form-control show-tick place-select1" type="text"
                                                                id="district" autocomplete="off" name="district" disabled="true">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-4">
                                                ...
                                                <button type="submit" class="btn btn-primary m-t-15 waves-effect"
                                                        name="edit-city" value="submit">Save Changes</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
