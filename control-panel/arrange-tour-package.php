...
$TOUR_TYPE = new TourType($TOUR_PACKAGE->tourtype);
?>
<!DOCTYPE html>
<html> 
    <head>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    <?php
                                                    if (count($TOUR_PACKAGE->getToursByTypeId($TOUR_TYPE->id)) > 0) {
                                                        foreach ($TOUR_PACKAGE->getToursByTypeId($TOUR_TYPE->id) as $key => $img) {
                                                            ?>
