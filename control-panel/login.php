...
<head>
    ...
    <link href="plugins/sweetalert/sweetalert.css" type="text/css" rel="stylesheet">
            ...
            <div class="body">
                ...
                <form method="POST" action="" id="login-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <button class="btn btn-block bg-pink waves-effect" id="login" type="submit">SIGN IN</button>
                        </div>
                    </div>
