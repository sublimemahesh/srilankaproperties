                                ...
                                <div class="property-listing">
                                    <ul>
                                        <li class="type-rent col-md-12">
                                            <div class="col-md-6">
                                                <img src="images/property1.jpg" alt=""></a>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="property-info">
                                                    <h3><a>116 Waverly Place</a></h3>
                                                    <span class="service-sub">NYC</span>
                                                    <div class="row">
                                                        <div class="col-md-6 s-list">
                                                            ...
                                                            <a href="contact.php">
                                                                <button type="button" class="btn btn-primary s-list">Read More</button>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
