...
<!--                                            </form>-->
                                ...
                                <!--                                <div class="col-md-6 col-sm-6">
                                                                    ...
                                                                    <div class="padding-as25 lgray-bg">
                                                                        <p class="big">No.55 Isipathanarama Rd, Maharagama 10280 <br>
                                                                            PO Box. 908509<br>
                                                                            New York - USA</p>
                                                                        ...
                                                                        <section class="counters padding-tb45 accent-color text-align-center">
                                                                            <div class="fact-ico contact-font"> <i class="fa fa-phone "></i> </div>
                                                                            <span class="fact"><a href="#"><strong>+94 70 277 3500</strong></a></span>
                                                                            <br>
                                                                            <div class="fact-ico contact-font"> <i class="fa fa-envelope "></i> </div>
                                                                            <span class="fact"><a href="#"><strong>mail@synotec.lk</strong></a></span>
                                                                            <br>
                                                                            <div class="fact-ico contact-font"> <i class="fa fa-map-marker"></i> </div>
                                                                            <span class="fact"><a href="#"><strong>No.55 Isipathanarama Rd, Maharagama 10280</strong></a></span>
                                                                            <br>
                                                                            <div class="fact-ico"> <i class="fa fa-phone fa-4x"></i> </div>
                                                                            <span class="fact">+94 70 277 3500</span>
                                                                            <br>
                                                                        </section>
                                                                    </div>
                                                                </div>-->
